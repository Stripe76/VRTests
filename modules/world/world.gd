...
func _ready() -> void:
	...
	$VAMActor.load_scene(daz_model,genitals_model,library_folder,scene_folder,scene_file,hair_file)
...
func _on_next_mesh(align_material: bool = true) -> void:
	...
	$VAMActor.load_mesh_async(daz_model,genitals_model,scene_folder,scene_file,hair_file)
